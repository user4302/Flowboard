      ...
      {checklists.map((checklist) => {
        ...
        return (
          <div key={checklist.id} className="border border-slate-200 dark:border-slate-600 rounded-lg overflow-hidden">
            {/* Checklist header */}
            <div
              className="relative flex items-center justify-between p-3 bg-white dark:bg-slate-800 rounded-lg cursor-pointer hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors"
