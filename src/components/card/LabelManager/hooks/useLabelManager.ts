...
import { LabelManagerView } from '../../types/form.types';

interface UseLabelManagerProps {
  boardId: string;
  cardId: string;
  selectedLabelIds: string[];
}

export const useLabelManager = ({ boardId, cardId, selectedLabelIds }: UseLabelManagerProps) => {
  const {
    boards,
    addLabelToCard,
    removeLabelFromCard,
